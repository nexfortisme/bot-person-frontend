...
<template>
  ...
  <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false" @select="handleSelect">
    ...
    <RouterLink to="/pyl-tcg">
      <el-menu-item index="3">PYL TCG</el-menu-item>
    </RouterLink>
    <RouterLink to="/dashboard" v-if="authStore.isAuthenticated">
      <el-menu-item index="4">Dashboard</el-menu-item>
    </RouterLink>


    <div class="flex-grow" />

    <el-menu-item v-if="!authStore.isAuthenticated" index="5" @click="onLoginClick()">Login</el-menu-item>
    <el-sub-menu index="6-1" v-if="authStore.isAuthenticated">
      <template #title>
        {{ authStore.username }} &nbsp;&nbsp;
        <el-avatar shape="square" :size="40" :src="authStore.userPictureURL" />
      </template>
      <el-menu-item index="6-1-1" @click="logout()">Logout</el-menu-item>
    </el-sub-menu>
  </el-menu>
</template>
